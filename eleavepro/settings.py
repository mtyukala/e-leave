"""
Django settings for eleavepro project.
...
SECRET_KEY = 'oro#7m3viz^nw&%6d+)1i7j7r-udm#gcc35&t=x9!)nuplkl-h'
...
WSGI_APPLICATION = 'eleavepro.wsgi.application'
